      ...
      <section class="">
        ...
        <div class="row">
          ...
          <div class="col-md-5 col-lg-3 col-md-3 mt-3">
            ...
            <p>
              <a class="text-white">Cavite State University-CCAT Campus</a>
            </p>
            <p>
              <a class="text-white">Cavite State University Main Campus</a>
            </p>
            <p>
              <a class="text-white">OBE framework</a>
            </p>
            <p>
              <a class="text-white">PHL CHED Connect</a>
            </p>
          </div>
          ...
          <div class="col-md-5 col-lg-2 mx-auto">
            <div class="row">
              ...
              <div class="col-xs-6 col-md-6 mt-3">
                <a href="#"><img src="assets/images/Footer logos/foi_logo.png" class="img-fluid" alt=""></a>
              </div>
              <div class="col-xs-6 col-md-6 mt-3">
                <a href="#"><img src="assets/images/Footer logos/transparency-seal.png" class="img-fluid" alt=""></a>
              </div>
            </div>
          </div>
          <!-- Grid column -->
